...
**동작**
10. 도메인은 관찰하는 것이다.
11. LLM 은 핵심이지만 호출은 의존성 주입으로 분리 — 그래프 코어는 LLM 모듈 import 안 하고 콜백을 외부에서 받음. 콜백 미주입 시 무필터·Kiwi 단독 동작, 시냅스/갑질 같은 앱이 자기 LLM 함수를 주입.
...
| `DESIGN_SYSTEM.md` | 디자인 토큰·베이스 컴포넌트 가이드·핸드오프 번들 위치·F8 작업 절차 |
